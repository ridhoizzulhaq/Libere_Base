            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        <Link to="/openlibrary" className="nav-link">Open Library</Link>
                    </Nav>
                    <Nav className="ms-auto">
                        ...
                        {connected && account ? (
                            ...
                            >
                                <NavDropdown.Item as={Link} to="/items">My Items</NavDropdown.Item>
                                <NavDropdown.Item as={Link} to="/create-item">Create New Item</NavDropdown.Item> {/* Moved here */}
