...
function OpenLibrary() {
    ...
    const staticAccount = '0x734d5521231177D098F2E780d0d4bd26CF79248a'; // Static account for Open Library
    ...
    const fetchItems = async (retryCount = 3) => {
        try {
            setLoading(true);
            const response = await axios.get(`https://base-sepolia.blockscout.com/api/v2/addresses/${staticAccount}/nft?type=ERC-1155`);
